          ...
          <div className="relative">
            ...
            >
              ...
              <span className="relative inline-block">
                <span className={`text-transparent bg-clip-text font-semibold ${isDarkMode
                  ? 'bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400'
                  : 'bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600'
                  }`}>
                  extraordinary
                </span>
                <span className={`absolute inset-0 text-transparent bg-clip-text animate-pulse opacity-60 ${isDarkMode
                  ? 'bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400'
                  : 'bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600'
                  }`}>
                  extraordinary
